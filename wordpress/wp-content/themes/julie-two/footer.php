...
<script src="<?php echo get_template_directory_uri(); ?>/js/quantity.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/delete.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/carticon.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/custom-product-gallery.js"></script>
